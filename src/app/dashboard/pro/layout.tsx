...
// Ploy is a discovery/referral marketplace — it does not process AI tool
...
const navItems: DashboardNavItem[] = [
  ...
  { label: "Saved AI Tools", href: "/dashboard/pro/saved", icon: <Heart className="h-4 w-4" /> },
  { label: "My AI Tool", href: "/account/marketplace/listing", icon: <Sparkles className="h-4 w-4" /> },
];
