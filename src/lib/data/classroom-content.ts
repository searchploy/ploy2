    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "Price against the saving in their report, not against a number you invented. Then say it without apologising.",
          "Split the money into three lines: your setup fee, your monthly fee, and the vendor's subscription.",
          ...
          "Your first deals will be small. You're buying proof — that's what lets you charge more later."
        ]
      },
      {
        type: "homework",
        title: "Action Steps (Homework)",
        content: "You're ready to close deals. Practice it.\n\nTask 1: Write your proposal template\nCreate a simple template with:\n• What you'll do (timeline)\n• Timeline (specific weeks)\n• Investment, as three separate lines: your setup fee, your monthly fee, the vendor's subscription\n• The saving from their report, next to that total, so the ratio is visible\n• Success metrics (what you'll measure)\n• Their commitment (what they need to do)\n\nTask 2: Practice the close\nRecord yourself asking for the deal. Does it sound confident? Natural?\n\nTask 3: Close one deal\nPick one client who's ready. Use the 6-step framework. Close them.\n\nTask 4: After close\nFollow up consistently. Get them to sign. Get them started."
      }
    ]
  },
  {
    id: 8,
    title: "Implementing AI Employees",
    description: "Buy it, configure it, hand it over — and charge for the work.",
    readTime: "12 min read",
    sections: [
      {
        type: "intro",
        content: "They signed. Now you have to actually do the thing.\n\nThis is the module most AI consulting advice skips, and it's the one that decides whether you have a business or a hobby. A consultant who only recommends is a very expensive search engine. The client could have found that AI employee themselves — the marketplace is public.\n\nWhat they can't easily do is sit down for three hours and get it working properly inside their business.\n\nThat's the job. You buy the subscription, you configure it against how they actually operate, you test it, you train their team, and you stay on to keep it working. The report opened the door. The implementation is what they're paying for."
      },
      {
        type: "concept",
        title: "What You're Actually Selling",
        content: "Be honest with yourself about where your value sits, because it changes how you price and how you talk.\n\nYou are not building AI. The AI employee already exists. Someone else built it, maintains it, and runs the infrastructure.\n\nYou are not reselling software either. The client pays the vendor directly, or reimburses you. You're not making a margin on the subscription and you shouldn't pretend to.\n\nWhat you're selling is the gap between \"this tool exists\" and \"this tool is working in my business.\"\n\nThat gap is real, and for most small business owners it's wide:\n• They don't know which of forty options fits their situation\n• They don't have time to evaluate, buy, and configure it\n• They don't know what good configuration looks like\n• They won't notice when it starts drifting or under-performing\n• They'll abandon it the first time it does something odd, unless someone explains why\n\nEvery one of those is billable. None of them require you to write code."
      },
      {
        type: "framework",
        title: "The Implementation",
        content: "Step 1: Agree who owns the account\nDecide this before you buy anything. Two options, both fine:\n\nClient-owned: They create the account with their card, you get access. Cleanest. They keep control, there's no awkwardness if you part ways, and you're never fronting money.\n\nConsultant-owned: You create the account on your card and bill it back. Faster to get moving, and some clients prefer never touching it. But you're now carrying their subscription cost on your card, so bill it back monthly and don't let it drift.\n\nWhichever you pick, write it into the proposal. \"The [vendor] account is in your name, I have admin access\" is one sentence that prevents a lot of grief later.\n\n---\n\nStep 2: Buy the right plan (not the biggest one)\nGo to the vendor's site. Look at the tiers. Match the tier to what the report actually said they need, not the tier that sounds impressive.\n\nMost vendors have a middle plan that covers a small business comfortably. Starting there and upgrading in month three is a much better story than starting high and having them notice they're paying for headroom they don't use.\n\nLog it in Ploy the moment you buy: Subscriptions → Add subscription. Which client, which AI employee, which vendor, what it costs, what you charged. You will not remember these details across six clients in four months. Nobody does.\n\n---\n\nStep 3: Configure it around how they actually work\nThis is the part that earns the fee, and it's mostly interviewing, not clicking.\n\nBefore you touch a settings screen, get:\n• Their actual tone — pull ten real emails or transcripts, don't guess\n• The specific things they will not say to a customer (pricing? availability? warranties?)\n• Where it hands off to a human, and to which human by name\n• Their operating hours, holidays, the seasonal stuff that trips automation up\n• The five questions they get every single day\n\nThen configure. Then read the output as if you were their customer. Then fix what makes you wince.\n\nA generic setup is what they'd have gotten on their own. The interview is the difference.\n\n---\n\nStep 4: Pilot before you switch it on\nDon't go live across everything on day one. Take a slice — one channel, one shift, one category of request.\n\nRun it for a week. Read every output. Note what's wrong. Fix it. Show them the before-and-after.\n\nThe pilot is doing two jobs. It catches configuration problems while they're cheap, and it gives the client something to watch, which is how they build trust in the thing they just bought.\n\n---\n\nStep 5: Train the human who has to live with it\nThere is always one person on their team who now works alongside this thing. Find out who, before you go live.\n\nSit with them for an hour. Show them what it does, what it doesn't do, how to hand something back to a person, and who to call when it's wrong.\n\nIf that person doesn't understand it, they will quietly route around it, and in two months the client will conclude AI doesn't work. You'll never hear the real reason.\n\n---\n\nStep 6: Stay\nThis is what the monthly fee is for, and you have to actually do it or you won't keep it.\n\nEvery month:\n• Look at what it's handling and what it's escalating\n• Read a sample of the output — is it drifting?\n• Ask the human from step 5 what's annoying them\n• Check whether the plan still fits, up or down\n• Send the client a short note: here's what it did this month\n\nThat last one matters more than it sounds. A client who gets a monthly note renews. A client who hears nothing starts wondering what they're paying for."
      },
      {
        type: "concept",
        title: "Pricing the Implementation",
        content: "Two numbers: one-time and monthly. Both come from their report, not from a table.\n\nThe setup fee covers the work in steps 1–5. Interview, configure, pilot, train. Scope it by how long that honestly takes you — and for your first few, it will take longer than you expect, which is fine. You're learning on your own time, not billing for the learning.\n\nThe monthly fee covers step 6. It has to be small enough that they don't re-examine it every month, and large enough that you'll actually do the work. A fee you resent is a fee you'll stop earning.\n\nSanity-check both against the report's estimated annual saving. Setup plus twelve months of management should sit comfortably inside it, with the vendor subscription counted too. If it doesn't, either the price is wrong or this AI employee isn't the right one for them — and saying so is worth more than the deal.\n\nWhat not to do:\n\nDon't copy a price off the internet. You don't know that consultant's market, client size, or what they actually deliver. Half the numbers people post are aspirational.\n\nDon't price on hours alone. You'll get faster, and pricing on hours means getting faster earns you less.\n\nDon't mark up the vendor subscription quietly. If you're carrying it on your card, bill it at cost and say so. Getting caught adding 30% to a line item they can look up in ten seconds costs you the relationship over a small amount of money."
      },
      {
        type: "mistakes",
        title: "Common Mistakes",
        content: "Mistake 1: Handing over a login and calling it done\nYou buy the subscription, email them the password, invoice for implementation.\nResult: They could have done that themselves. They know it. No renewal, and probably no referral.\nBetter: The configuration interview is the product. If you skipped it, you didn't implement anything.\n\nMistake 2: Configuring from the report instead of from the business\nThe report says \"customer support bottleneck,\" so you set up a support agent using what the report told you.\nResult: Something generic that sounds nothing like them.\nBetter: The report picks the tool. The interview configures it. Skipping the second step is why so many AI rollouts feel off.\n\nMistake 3: Going live everywhere on day one\nYou switch it on across all channels because it's exciting and you want the win.\nResult: The first bad output happens in front of a real customer and you've lost the client's nerve.\nBetter: Pilot one slice. Boring, and it works.\n\nMistake 4: Charging a monthly fee and then disappearing\nYou take the retainer, do nothing, and hope they don't notice.\nResult: They notice around month three. You lose the recurring revenue and the referral.\nBetter: Do the monthly check. Send the note. It's maybe an hour per client.\n\nMistake 5: Fronting subscription costs and forgetting to bill them\nYou put three clients' subscriptions on your card during a busy month.\nResult: You're quietly funding their AI tooling.\nBetter: Log every subscription the day you buy it, bill the pass-through on the same cycle as your fee."
      },
      {
        type: "takeaways",
        content: [
          "Recommending is not implementing. The client could have found the listing themselves — the gap between owning the tool and running it is what you sell.",
          "Decide who owns the vendor account before you buy anything, and write it into the proposal.",
          "The configuration interview is the actual work. Pull real emails, real questions, real handoff rules.",
          "Pilot one slice before switching everything on.",
          "Train the specific human who has to work alongside it, or they'll route around it.",
          "The monthly fee buys monthly attention. Do the check, send the note.",
          "Log every subscription in Ploy the day you buy it — client, vendor, cost, your fee.",
          "Bill pass-through costs at cost. A quiet markup on a price they can look up isn't worth the relationship."
        ]
      },
      {
        type: "homework",
        title: "Action Steps (Homework)",
        content: "Task 1: Write your configuration interview\nList the questions you'll ask every client before touching a settings screen. Tone, restrictions, handoff rules, hours, the five daily questions. Ten to fifteen questions. You'll reuse this on every single implementation — build it once.\n\nTask 2: Do a dry run\nPick an AI employee from the marketplace. Sign up for a trial. Configure it as though you had a client, using a real business you know well. Time yourself.\nThat number is what your setup fee has to cover.\n\nTask 3: Price your first implementation\nTake a report you've generated. Find the estimated annual saving. Work out a setup fee and a monthly fee that sit comfortably inside it once the vendor subscription is counted.\nWrite down the sentence you'd say out loud to present it.\n\nTask 4: Set up your tracking\nOpen Subscriptions in your dashboard. Add a row for anything you've already sold. If you haven't sold one yet, add a test row so you know the workflow before you need it under pressure."
      }
    ]
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Model 1: Setup fees only (where everyone starts)\nYou charge to implement an AI employee, then you're done. One payment per job.\n\nPros: Simple. Easy to explain. Cash arrives quickly.\nCons: You start from zero every month. Every month's income depends on finding someone new.\nUse for: Your first two or three clients, while you work out what implementation actually takes you.\n\n---\n\nModel 2: Setup plus management (the one that compounds)\nSetup fee to implement, then a monthly fee to manage it. Same work as Model 1, but you stay.\n\nPros: This month's income doesn't depend on this month's selling. Ten clients paying monthly is a floor under you. And you're already inside the business when they're ready for a second AI employee.\nCons: You have to keep earning it. A client paying monthly for nothing will eventually notice.\nUse for: Your core business. This is the model the whole Ploy workflow is built around.\n\n---\n\nModel 3: Management across several employees per client (where it gets interesting)\nOnce a client trusts the first AI employee, the second is a far easier conversation than the first was. Same business, same relationship, no new sales cycle. Your monthly fee grows per client rather than per new logo.\n\nPros: Cheapest growth available to you — no acquisition cost at all.\nCons: Concentration. If a big client leaves, a lot goes at once.\nUse for: Deepening accounts you've already earned, rather than only chasing new ones.\n\n---\n\nA note on the numbers: this course deliberately doesn't tell you what to charge. Rates vary enormously by market, client size, and what you actually deliver, and any figure printed here would be a guess dressed up as guidance. Price off the saving in each client's report, and let your own closed deals — not someone else's — tell you when to raise."
      },
      {
        type: "framework",
        title: "Building a Sustainable Business",
        content: "Step 1: Set up the monthly fee at the start, not after\nThe easiest time to agree a management fee is in the original proposal, before anything is running. Going back afterwards to ask for something ongoing reads as an upsell, even when it isn't.\n\nSo put it in from the beginning: setup fee, then monthly. If you've already closed someone on setup alone, have the conversation at the point they're happiest — right after the pilot works.\n\n\"It's running well. One thing worth deciding now: this drifts if nobody's watching it. Their model changes, your business changes, and in three months the answers aren't quite right any more.\n\nWhat I'd suggest is I stay on it — I check the output monthly, tune it as your business shifts, handle the vendor when something breaks, and send you a note on what it handled. That's $[X] a month.\n\nOr I hand it over completely and you call me if it goes wrong. Genuinely fine either way — but decide now rather than in month four.\"\n\nWhy this works:\n• It names a real risk rather than inventing one — configurations do drift\n• The alternative is offered honestly, so it isn't a squeeze\n• It lands while the result is visible\n• \"Decide now\" gives them a reason to answer today\n\n---\n\nStep 2: Generate referrals from happy clients\nHappy clients are your best salesperson. But you have to ask.\n\nAfter 60 days of implementation (when they're seeing results):\n\n\"How's the AI project going?\"\n[They tell you it's going great]\n\n\"I'm so glad. Here's what I'm working on: I help [type of business] implement AI to [outcome]. You're a great example.\n\nDo you know anyone else who [has the same problem]? If you think of someone, I'd love an intro. I always take care of my referral sources.\"\n\nWhy this works:\n• You're asking after results are visible\n• You're specific about who you help\n• You're making it easy (just an intro)\n• You're offering something in return (not specified, but implied)\n\nAnd make the offer concrete:\n\n\"If you refer someone and it turns into work, I pay referral fees — normally a percentage of the first invoice. Or a credit against your own monthly fee, if that's more useful to you. Your call.\"\n\nPick a percentage you can pay every time without resenting it, and then actually pay it. A referral arrangement you wriggle out of once is one you'll never get to use again.\n\n---\n\nStep 3: Build authority (so referrals come without asking)\nThe consultant who's \"the expert\" gets referrals without asking.\n\nThe consultant who's invisible has to ask constantly.\n\nBuild authority by:\n\nCreating content:\n• LinkedIn posts about AI opportunities in your industry\n• Case studies from your clients (anonymized)\n• Blog posts on your website about problems you solve\n• Thread-posting on Twitter/X\n\nNetworking:\n• Join industry groups\n• Speak at events\n• Host workshops\n• Build relationships with other consultants (they refer to you)\n\nCase studies:\n• Document your wins\n• Share (anonymized) results\n• Show real impact\n\n---\n\nStep 4: Package your services\nInstead of writing a custom proposal every time, have two or three standard shapes. Fill in your own numbers — the structure is what's reusable, not the price.\n\nSingle employee\n• Report and recommendation\n• One AI employee bought and configured\n• Pilot, then switch-on\n• Team training\n• Monthly management from there\n\nDepartment\n• Everything above, across two or three AI employees covering one function\n• Handoff rules between them\n• One monthly review covering the whole set\n\nOngoing partner\n• Standing arrangement: new AI employees added as the business grows\n• Quarterly look at what else is worth automating\n• Priority when something breaks\n\nSet your own prices for each, from the savings in the reports you've actually run. Then quote the same numbers every time, so you're not re-deciding under pressure on a call.\n\nWhy this works:\n• Faster sales (they pick a package, not haggle)\n• You control scope (not custom every time)\n• Higher margins (less custom work = more efficiency)\n• Clearer value (they know what they get)\n\n---\n\nStep 5: Hire help (so you don't stay stuck at 1x)\nOnce you have 2-3 retainer clients + project work, you're capped.\n\nYou can't grow without hiring.\n\nFirst hires:\n\n1. Implementation contractor ($25-40/hour)\n• Handles setup and technical implementation\n• Frees you for sales and strategy\n• Start with project-based, convert to retainer\n\n2. Operations person (part-time initially)\n• Handles client scheduling, follow-ups, proposals\n• Lets you focus on selling and strategy\n\n3. Sales/business development (if you hate sales)\n• Generates leads\n• Books discovery calls\n• You close them\n\nThe goal: You move from doing the work to managing it."
      },
      {
        type: "mistakes",
        title: "Common Mistakes",
        content: "Mistake 1: Treating every client like it's temporary\nYou land a client. You implement. You move on.\nResult: You're always hustling for the next client. Unpredictable revenue.\nBetter: Convert to retainer. Build the relationship. Get referrals.\n\nMistake 2: Being invisible\nYou do great work but don't tell anyone.\nResult: You have to cold-outreach for every deal.\nBetter: Post about your work. Build authority. Referrals come to you.\n\nMistake 3: Custom every time\nEach client gets a custom proposal, custom scope, custom price.\nResult: Sales cycle takes forever. You can't scale. Clients negotiate price down.\nBetter: Have three packages. They pick one. Move faster.\n\nMistake 4: Staying stuck at 1x\nYou land 2-3 retainer clients and you're fully booked.\nSomeone asks for help. You turn them down. Revenue stays flat.\nResult: You're not building a business. You're a freelancer with a retainer.\nBetter: Hire help. Move from doing work to managing it.\n\nMistake 5: Never revisiting your price\nYou set a fee on your first deal, when you had nothing to point at, and you're still charging it eight clients later.\nResult: You're pricing like a beginner long after you've stopped being one.\nBetter: Re-price on new deals once you have documented results. Not because a course told you a number, but because you can now show what happened for the last three clients. That's the thing that justifies a higher fee — and it's also the only thing that makes it easy to say."
      },
      {
        type: "takeaways",
        content: [
          "Recurring revenue is the goal. Setup fees are how you start. Management fees are how you stop starting from zero every month.",
          "Put the monthly fee in the original proposal. Adding it afterwards always reads as an upsell.",
          "The second AI employee for an existing client is the cheapest sale you will ever make.",
          "Build authority so referrals come to you. LinkedIn posts, case studies, speaking, networking.",
          "Package the shape of your offerings, then fill in your own numbers from your own reports.",
          "Hire help to scale. Implementation contractors, operations people, sales folks. Move from doing to managing.",
          "Raise your prices off documented results, not off a figure someone posted online.",
      ...
      },
      {
        type: "homework",
        title: "Action Steps (Homework)",
        content: "You've landed clients. Now build a real business.\n\nTask 1: Get one management fee agreed\nIf you have a client from Module 8, have the conversation — ideally right after their pilot worked.\nOffer both options honestly: you stay on monthly, or you hand it over and they call you when it breaks.\nRecord their answer. If they hesitated, use the objection-handling framework from Module 6. Then check your Subscriptions tab shows the monthly fee, so it's counted in your recurring total.\n\nTask 2: Ask for referrals\nEmail your happy clients: \"You're a great example of [outcome]. Do you know anyone else with [similar problem]? I'd love an intro. Always take care of my referral sources.\"\nSee how many responses you get.\n\nTask 3: Create content\nWrite a LinkedIn post about a client win (anonymized). Insights they gained. Results they saw. Tag relevant people/companies.\nPost it. See how many people engage.\n\nTask 4: Build your packages\nWrite down two or three service shapes — single employee, department, ongoing partner — and what's included in each.\nThen price them yourself, using the estimated savings from reports you've actually run. Not from a number in this course, and not from something you read on LinkedIn.\nWrite the prices down and quote them consistently. Deciding your price live on a call is how you end up discounting."
      }
    ]
  }
];
